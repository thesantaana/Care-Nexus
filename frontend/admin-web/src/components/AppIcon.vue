...
const icons = {
  ...
  book: ['M4 4.5A2.5 2.5 0 0 1 6.5 2H11v18H6.5A2.5 2.5 0 0 0 4 22V4.5Z', 'M20 4.5A2.5 2.5 0 0 0 17.5 2H13v18h4.5A2.5 2.5 0 0 1 20 22V4.5Z'],
  tag: ['M20 12 12 20l-9-9V4h7l10 8Z', 'M7.5 8h.01'],
  care: ['M12 21s-7-4.35-7-10a4 4 0 0 1 7-2.65A4 4 0 0 1 19 11c0 5.65-7 10-7 10Z', 'M8.5 13h2l1-2 1.5 4 1-2H16'],
  doctor: ['M8 3v4a4 4 0 0 0 8 0V3', 'M6 3h4', 'M14 3h4', 'M12 11v2a5 5 0 0 0 5 5h1', 'M18 18a2 2 0 1 0 4 0 2 2 0 0 0-4 0Z'],
  ...
  refresh: ['M20 7h-5V2', 'M20 7a8 8 0 1 0 2 5'],
